...
import logo from "../assets/images/yellow.png";
    ...
    >
      <div className="flex w-full flex-wrap items-center justify-between px-6">
        <div className="flex items-center">
          ...
          <a className="text-primary dark:text-primary-400 h-16 w-16 " href="/">
            <img
              src={logo}
              alt=""
          ...
          <span className="text-xl font-bold">FoodCircle</span>
        </div>

        <div
          className="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto md:mx-24"
